    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-[#1F2937] overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="flex flex-row justify-between items-center">
                    <div class="flex flex-row gap-x-5 items-center">
                        ...
                        <div>
                            ...
                            <h3 class="text-slate-100 text-xl font-bold">Rp 0</h3>
                        </div>
                    </div>
                </div>
                <hr class="my-5">
                ...
                <div>
                    <h3 class="text-slate-100 text-xl font-bold mb-5">Send Payment to:</h3>
                    <div class="flex flex-row gap-x-10">
                        <div>
                            <p class="text-slate-500 text-sm">Bank</p>
                            <h3 class="text-slate-100 text-xl font-bold">Zaky Capital</h3>
                        </div>
                        <div>
                            <p class="text-slate-500 text-sm">No Account</p>
                            <h3 class="text-slate-100 text-xl font-bold">08123092093</h3>
                        </div>
                        <div>
                            <p class="text-slate-500 text-sm">Account Name</p>
                            <h3 class="text-slate-100 text-xl font-bold">Gawebro Indonesia</h3>
                        </div>
                    </div>
                ...
                <h3 class="text-slate-100 text-xl font-bold">Confirm Topup Wallet</h3>
